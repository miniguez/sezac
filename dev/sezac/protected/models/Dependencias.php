...
class Dependencias extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('abreviatura', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nombre, abreviatura', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'encargadoses' => array(self::HAS_MANY, 'Encargados', 'idDependecia'),
			'unidadesResponsables' => array(self::HAS_MANY, 'UnidadesResponsables', 'idDependecia'),
		);
	}
