 ...
 *
 * Modified to make it compatible for TbGroupGridView
 * @author Amr Bedair <https://github.com/amrbedair>
 */
...
(function ($) {
	...
	methods = {
		...
		getSelection: function () {
			var settings = gridSettings[this.attr('id')],
				...
				selection = [];
			this.find('.' + settings.tableClass).children('tbody').children().not('.extrarow').each(function (i) {
	...
	$.fn.yiiGroupGridView = function (method) {
		if (methods[method]) {
